...
//		PK = "WALLET#<WalletID>"
//		SK = "TX#<Date>#<ID>"
//		GSI_ByTransactionTypePK = "TX_TYPE#<Type>"
//		GSI_ByTransactionTypeSK = "TX#<Date>#<ID>"
//	 	GSI_ByTransactionID = "TX_ID#<ID>"
type Transaction struct {
	PK                      string          `dynamodbav:"PK"`
	SK                      string          `dynamodbav:"SK"`
	GSI_ByTransactionTypePK string          `dynamodbav:"GSI_PK"`
	GSI_ByTransactionTypeSK string          `dynamodbav:"GSI_SK"`
...
func NewTransaction(id, walletID, walletName, categoryID, categoryName, description, currency, imageURL string, txType TransactionType, amount float64, date time.Time) *Transaction {
	...
	return &Transaction{
		PK:                      "WALLET#" + walletID,
		SK:                      "TX#" + dateStr + "#" + id,
		GSI_ByTransactionTypePK: "TX_TYPE#" + string(txType),
		GSI_ByTransactionTypeSK: "TX#" + dateStr + "#" + id,
		GSI_ByTransactionID:     "TX_ID#" + id,
		ID:                      id,
		WalletID:                walletID,
